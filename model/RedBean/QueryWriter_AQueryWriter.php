 ...
 */
abstract class QueryWriter_AQueryWriter { //bracket must be here - otherwise coverage software does not understand.
	/**
	...
	protected function check( $struct )
	{
		if ( !preg_match( '/^[a-zA-Z0-9_]+$/', $struct ) ) {
			throw new Exception_Security( 'Identifier does not conform to RedBeanPHP security policies.' );
		}
