 ...
 */
class Plugin_QueryLogger implements Observer, Plugin
{
	 ...
	 * @param  Adapter_DBAdapter $adapter   adapter that sends the signal
	 *
	 * @return void
	 */
