 ...
 */
class QueryWriter_CUBRID extends QueryWriter_AQueryWriter implements QueryWriter
{
	/**
	 * Data types
	 */
	...
	public function __construct( Adapter $adapter )
	{
		$this->typeno_sqltype = array(
			QueryWriter_CUBRID::C_DATATYPE_INTEGER          => ' INTEGER ',
			QueryWriter_CUBRID::C_DATATYPE_DOUBLE           => ' DOUBLE ',
			QueryWriter_CUBRID::C_DATATYPE_STRING           => ' STRING ',
			QueryWriter_CUBRID::C_DATATYPE_SPECIAL_DATE     => ' DATE ',
			QueryWriter_CUBRID::C_DATATYPE_SPECIAL_DATETIME => ' DATETIME ',
		);
