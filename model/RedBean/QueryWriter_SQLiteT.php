 ...
 */
class QueryWriter_SQLiteT extends QueryWriter_AQueryWriter implements QueryWriter
{
	/**
	...
	public function __construct( Adapter $adapter )
	{
		$this->typeno_sqltype = array(
			QueryWriter_SQLiteT::C_DATATYPE_INTEGER => 'INTEGER',
			QueryWriter_SQLiteT::C_DATATYPE_NUMERIC => 'NUMERIC',
			QueryWriter_SQLiteT::C_DATATYPE_TEXT    => 'TEXT',
		);
