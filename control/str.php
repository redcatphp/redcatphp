...
class str{
	static function tolower($str){ //the strtolower version to support most amount of languages including russian, french and so on - http://www.php.net/manual/fr/function.strtolower.php
		static $to = array(
		...
		return str_replace($from, $to, strtolower($str));
	} 
