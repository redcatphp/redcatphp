<?php
namespace I18n\Punic\Exception;

/**
 * An exception raised when an data file was not read
 */
class DataFileNotReadable extends \I18n\Punic\Exception
{
    ...
    public function __construct($dataFilePath, $previous = null)
    {
        ...
        parent::__construct($message, \I18n\Punic\Exception::DATA_FILE_NOT_READABLE, $previous);
    }
