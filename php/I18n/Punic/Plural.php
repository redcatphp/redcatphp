...
class Plural
{
    ...
    {
        $node = \I18n\Punic\Data::getLanguageNode(\I18n\Punic\Data::getGeneric('plurals'), $locale);
     ...
     * @throws \I18n\Punic\Exception\BadArgumentType Throws a \I18n\Punic\Exception\BadArgumentType if $number is not a valid number
