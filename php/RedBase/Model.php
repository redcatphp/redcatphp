...
use RedBase\RedBeanPHP\SimpleModel;
use RedBase\RedBeanPHP\QueryWriter\AQueryWriter;
use BadMethodCallException;
use RedBase\ValidationException; //for allowing mirrored exception class catching and (optional) hook
