<?php 
namespace RedBase\DataMapper\Relation;
class ManyMany implements \Iterator, \ArrayAccess, \Countable, \RedBase\DataMapper\Relation {
	private $results;
	private $localField;
	private $parentField;
	private $iterator = 0;
	...
	public function __construct(\RedBase\DataMapper\Maphper $intermediateMapper, \RedBase\DataMapper\Maphper $relatedMapper, $localField='id', $parentField, $intermediateName = null, $isDependent=true) {
