...
class Many implements \RedBase\DataMapper\Relation {
	private $mapper;
	private $parentField;
	private $localField;
	private $criteria = [];
	...
	public function __construct(\RedBase\DataMapper\Maphper $mapper, $parentField, $localField, array $critiera = [], $isDependent=true) {
		$this->mapper = $mapper;
