...
class One implements \RedBase\DataMapper\Relation {
	private $mapper;
	private $parentField;
	private $localField;
	...
	public function __construct(\RedBase\DataMapper\Maphper $mapper, $parentField, $localField, array $criteria = [], $isDependent=true) {
		$this->mapper = $mapper;
