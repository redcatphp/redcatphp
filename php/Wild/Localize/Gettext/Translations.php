<?php
namespace Wild\Localize\Gettext;
...
class Translations extends \ArrayObject
{
    ...
    public static function __callStatic($name, $arguments)
    {
        ...
        return call_user_func_array('Wild\\Localize\\Gettext\\Extractors\\'.$matches[1].'::from'.$matches[2], $arguments);
    }
    ...
    public function __call($name, $arguments)
    {
        ...
        return call_user_func_array('Wild\\Localize\\Gettext\\Generators\\'.$matches[1].'::to'.$matches[2], $arguments);
    }
