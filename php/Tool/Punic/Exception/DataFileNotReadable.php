<?php
namespace Surikat\Tool\Surikat\Tool\Punic\Exception;

/**
 * An exception raised when an data file was not read
 */
class DataFileNotReadable extends \Surikat\Tool\Punic\Exception
{
    ...
    public function __construct($dataFilePath, $previous = null)
    {
        ...
        parent::__construct($message, \Surikat\Tool\Punic\Exception::DATA_FILE_NOT_READABLE, $previous);
    }
