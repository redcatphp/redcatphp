...
class Plural
{
    ...
    {
        $node = \Surikat\Tool\Punic\Data::getLanguageNode(\Surikat\Tool\Punic\Data::getGeneric('plurals'), $locale);
     ...
     * @throws \Surikat\Tool\Punic\Exception\BadArgumentType Throws a \Surikat\Tool\Punic\Exception\BadArgumentType if $number is not a valid number
