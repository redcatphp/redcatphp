<?php namespace Surikat\Tool\Geocoder;
use Surikat\Tool\Geocoder\Geocoder;
use Surikat\Tool\Geocoder\HttpAdapter\CurlHttpAdapter;
use Surikat\Tool\Geocoder\Provider\ChainProvider;
use Surikat\Tool\Geocoder\Provider\FreeGeoIpProvider;
use Surikat\Tool\Geocoder\Provider\HostIpProvider;
use Surikat\Tool\Geocoder\Provider\GoogleMapsProvider;
use Surikat\Tool\Geocoder\Provider\NominatimProvider;
use Surikat\Tool\Geocoder\Provider\OpenStreetMapProvider;
...
class RadiusFinder{
	static function byAddress($val,&$lat=null,&$lon=null,$debug=false){
		...
		catch(\Surikat\Tool\Geocoder\Exception\ChainNoResultException $e){
			if($debug)
				echo $e->getMessage()."\r\n";
			return 0;
		}
