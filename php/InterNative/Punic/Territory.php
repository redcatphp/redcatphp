...
class Territory
{
    ...
    public static function getList($levels = 'W', $locale = '')
    {
        ...
        if (count($decodedLevels) === 0) {
            throw new \InterNative\Punic\Exception\BadArgumentType($levels, "list of territory kinds: it should be a list of one or more of the codes '" . implode("', '", array_keys($levelMap)) . "'");
        }
