<?php namespace Geocoding;
use Geocoding\Geocoder\Geocoder;
use Geocoding\Geocoder\HttpAdapter\CurlHttpAdapter;
use Geocoding\Geocoder\Provider\ChainProvider;
use Geocoding\Geocoder\Provider\FreeGeoIpProvider;
use Geocoding\Geocoder\Provider\HostIpProvider;
use Geocoding\Geocoder\Provider\GoogleMapsProvider;
use Geocoding\Geocoder\Provider\NominatimProvider;
use Geocoding\Geocoder\Provider\OpenStreetMapProvider;
...
class RadiusFinder{
	static function byAddress($val,&$lat=null,&$lon=null,$debug=false){
		...
		catch(\Geocoding\Geocoder\Exception\ChainNoResultException $e){
			if($debug)
				echo $e->getMessage()."\r\n";
			return 0;
		}
