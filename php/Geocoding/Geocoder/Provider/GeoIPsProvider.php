...
namespace Geocoding\Geocoder\Provider;

use Geocoding\Geocoder\Exception\InvalidCredentialsException;
use Geocoding\Geocoder\Exception\NoResultException;
use Geocoding\Geocoder\Exception\UnsupportedException;
use Geocoding\Geocoder\Exception\InvalidArgumentException;
use Geocoding\Geocoder\Exception\QuotaExceededException;
use Geocoding\Geocoder\HttpAdapter\HttpAdapterInterface;
