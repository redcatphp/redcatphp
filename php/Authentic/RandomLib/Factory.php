...
namespace Authentic\RandomLib;

use Authentic\SecurityLib\Strength;
 ...
 * @author     Anthony Ferrara <ircmaxell@ircmaxell.com>
 */
class Factory extends \Authentic\SecurityLib\AbstractFactory {
     ...
     */
    public function getGenerator(\Authentic\SecurityLib\Strength $strength) {
     ...
     */
    protected function findMixer(\Authentic\SecurityLib\Strength $strength) {
        $newMixer = null;
        $fallback = null;
