 ...
 */
namespace Authentic\SecurityLib;
...
abstract class BigMath {
    ...
    public static function createFromServerConfiguration() {
        ...
        if (extension_loaded('gmp')) {
            return new \Authentic\SecurityLib\BigMath\GMP();
        } elseif (extension_loaded('bcmath')) {
            return new \Authentic\SecurityLib\BigMath\BCMath();
        } else {
            return new \Authentic\SecurityLib\BigMath\PHPMath();
        }
