...
class TmlLoremipsum extends \Surikat\Component\Templator\Tml {
	...
	function load(){
		...
		$this->innerHead[] = "<?php echo Surikat\Component\Dev\LoremIpsum::get($count,$wordsPerParagraph,$format,$loremipsum,$html,$mini);?>";
	}
}