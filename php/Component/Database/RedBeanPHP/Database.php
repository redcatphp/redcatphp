...
use Surikat\Component\Database\RedBeanPHP\OODB as OODB;
...
use Surikat\Component\Database\RedBeanPHP\AssociationManager as AssociationManager;
use Surikat\Component\Database\RedBeanPHP\TagManager as TagManager;
use Surikat\Component\Database\RedBeanPHP\DuplicationManager as DuplicationManager;
use Surikat\Component\Database\RedBeanPHP\LabelMaker as LabelMaker;
use Surikat\Component\Database\RedBeanPHP\Finder as Finder;
...
use Surikat\Component\Database\RedBeanPHP\Logger\RDefault\Debug as Debug;
use Surikat\Component\Database\RedBeanPHP\OODBBean as OODBBean;
use Surikat\Component\Database\RedBeanPHP\SimpleModel as SimpleModel;
use Surikat\Component\Database\RedBeanPHP\SimpleModelHelper as SimpleModelHelper;
use Surikat\Component\Database\RedBeanPHP\Adapter as Adapter;
use Surikat\Component\Database\RedBeanPHP\QueryWriter\AQueryWriter as AQueryWriter;
...
class Database{
	...
	function setup( $dsn = NULL, $user = NULL, $pass = NULL, $frozen = FALSE, $prefix = '', $case = true ){
		...
		$writerClass = '\\Surikat\\Component\\Database\\RedBeanPHP\\QueryWriter\\'.$writers[$wkey];
