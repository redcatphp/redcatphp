...
namespace Surikat\Component\Database\RedBeanPHP\Repository;
...
class Fluid extends Repository
{
	...
	public function dispense( $type, $number = 1, $alwaysReturnArray = FALSE )
	{
		$beans = [];
		for ( $i = 0; $i < $number; $i++ ) {
			$OODBBEAN = defined( 'REDBEAN_OODBBEAN_CLASS' ) ? REDBEAN_OODBBEAN_CLASS : 'Surikat\Component\Database\RedBeanPHP\OODBBean';
